...
namespace Mimeo.ConsoleApp.TestWorkers
{
    public class SampleWorker04
    {
        ...
        {
            _imageFactory
                .SetLocalDirectory(@"C:\DEV\Mimeo\TestFileStorage\0004\")
            ...
            content.Add(new SingleBlock(_fragmentFactory.Html("<h3>Global Plus - Aviation &amp; Air Travel</h3>")));


            var image1
                = _imageFactory
                    .GetImage("Danny.png")
                    .SetTitle("What's Danny Doing")
                    .SetAlt("What's Danny Doing")
                    .SetStyle("max-width", "150px");
            var article1 = new DoubleBlock(
                _fragmentFactory.Html(
                    @"<h4><a href=""https://www.whatsdannydoing.com/blog/interesting-facts-about-travelling"">
                        50 Interesting Facts About Travelling</a></h4>
                    <p  style=""padding-right:20px;""><strong>What's Danny Doing:</strong> Did you know that Sudan hosts more pyramids than Egypt, 
                    with over 250 ancient structures? Meanwhile, Bangkok holds the title for the most visited city worldwide, 
                    and Monaco is smaller than New York's Central Park. Interestingly, the world’s tallest sandcastle 
                    was built in Germany, reaching nearly 18 meters into the sky. For aviation enthusiasts, 
                    those smoke lines seen trailing from airplanes are actually water vapor, 
                    an indicator of the atmospheric conditions <em>(What's Danny Doing)</em>.</p>"),
                    _fragmentFactory.Image(image1, "https://www.whatsdannydoing.com/blog/interesting-facts-about-travelling"),
            ...
            var image2
                = _imageFactory
                    ...
                    .SetAlt("Kiwi")
                    .SetStyle("max-width", "150px");
            var article2 = new DoubleBlock(
                _fragmentFactory.Html(
                    @"<h4><a href=""https://www.kiwi.com/stories/15-fun-facts-airplanes-flying-surprise-you/"">
                    What Did People Use Before There Were Bathrooms On The Planes?</a></h4>
                    <p  style=""padding-right:20px;""><strong>Kiwi.com:</strong> Before the pandemic, the Seoul–Jeju route in South Korea was 
                    the busiest in the world, with 250 daily flights. The busiest day in aviation history saw over 
                    225,000 flights on July 24, 2019. Airplanes, like the Boeing 747, contain over 150 miles of wiring. 
                    Round windows in airplanes became a standard design to enhance safety, as square windows led to 
                    accidents due to pressure issues. The Lockheed SR-71 Blackbird remains the fastest man jet, 
                    and the Rutan Model 76 Voyager was the first plane to circumnavigate the globe without stops in 1986 <em>(Kiwi.com)</em>.</p>"),
                _fragmentFactory.Image(image2, "https://www.flyingmag.com/why-can-airplanes-fly-upside-down/"),
                new StyleBag() { { "margin-bottom", "10px" } });
            ...
            var image3
                = _imageFactory
                    .GetImage("UpsideDown.png")
                    .SetTitle("Flying")
                    .SetAlt("Flying")
                    .SetStyle("max-width", "150px");
            var article3 = new DoubleBlock(
                _fragmentFactory.Html(
                    @"<h4><a href=""https://www.flyingmag.com/why-can-airplanes-fly-upside-down/"">
                        Why Can Airplanes fly Upside Down (Not Right Side Up)</a></h4>
                    <p  style=""padding-right:20px;""><strong>FLYING Magazine:</strong> Explores the aerodynamics of airfoils and how, fundamentally, all wings can 
                    generate lift when the angle of attack is adjusted, even when inverted. This piece debunks common 
                    misconceptions about the necessity of a particular shape for lift, suggesting that even with camber 
                    (the hump-like shape of many airfoils), inverted flight is possible through controlling the 
                    the angle of attack carefully <em>(FLYING Magazine)</em>.</p>"),
                _fragmentFactory.Image(image3, "https://www.flyingmag.com/why-can-airplanes-fly-upside-down/"),
                new StyleBag() { { "margin-bottom", "10px" } });

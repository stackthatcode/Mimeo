...
namespace Mimeo.ConsoleApp.TestWorkers
{
    public class SampleWorker06
    {
        ...
        at com.example.myproject.Main.main(Main.java:14).</p>"));


            content.Add(article1);

            content.Add(new SingleBlock(_fragmentFactory.Html("<p></p>")));
            content.Add(new SingleBlock(_fragmentFactory.Html("<p></p>")));
            content.Add(new SingleBlock(_fragmentFactory.Html("<p></p>")));
            content.Add(new SingleBlock(_fragmentFactory.Html("<p></p>")));
            content.Add(new SingleBlock(_fragmentFactory.Html("<p></p>")));

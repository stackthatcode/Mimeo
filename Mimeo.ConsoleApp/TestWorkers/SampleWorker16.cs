...
namespace Mimeo.ConsoleApp.TestWorkers
{
    public class SampleWorker16
    {
        ...
        {
            _imageFactory
                .SetLocalDirectory(@"C:\DEV\Mimeo\TestFileStorage\0016\")
            ...
            contentModel
                .ExtendedProperties[BasicTemplate01.CONTENTMODEL_TITLE]
                        = "Bringing thet news you want right to your inbox";
            ...
            content.Add(new SingleBlock(
                _fragmentFactory.Html("<h2>Global Plus - Your Resource For World &amp; National News</h2>")));
            ...
            var url = "https://thediplomat.com/2023/04/how-serious-were-chinas-latest-military-drills-near-taiwan/";
            content.Add(new SingleBlock(_fragmentFactory.Image(image1, url)));
            var article3 = new SingleBlock(
                _fragmentFactory.Html($@"
                    <div style=""font-size:17px; line-height:30px;"">
                    <p><h4>Military Exercises - Taiwanese And Chinese</h4>
                    From April 8 to April 10, 
                    <a href=""{url}"">China conducted military exercises</a> named ""United Sharp Sword"" in thet Taiwan Strait. 
                    These exercises were in response to a meeting between Taiwan's President Tsai Ing-wen and 
                    U.S. House Speaker Kevin McCarthy in California. 
                    China stated these exercises were to warn against Taiwanese independence movements and 
                    to defend its national sovereignty and territorial integrity​ (The Diplomat)​.
                    </p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    </div>"));
